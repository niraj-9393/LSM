...
function NavBar() {
    ...
    return (
        <div className='bg-[#10B981] w-full h-14 flex justify-between select-none'>
            <div className='flex gap-2 items-center p-5' onClick={() => navigate("/")}>
                <div><School className="text-[#1F2937]" strokeWidth={2.5} /></div>
                <div><p className=' text-[#1F2937] font-bold'>E-LEARNING</p></div>
            </div>
